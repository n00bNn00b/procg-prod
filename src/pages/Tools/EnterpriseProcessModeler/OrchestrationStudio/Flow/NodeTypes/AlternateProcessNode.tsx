    ...
    <div className="group">
      <div className="relative">
        <span
          ...
          className="absolute right-[-50px] top-[-50px] p-1 bg-black/30 text-white rounded-sm text-xs opacity-0 group-hover:opacity-100 transition-opacity duration-200"
        >
