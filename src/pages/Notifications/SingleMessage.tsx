          ...
          <div className="flex flex-col gap-4 w-full">
            {totalMessages.map(message => (
              ...
              <div className="flex text-dark-400 mb-4">
                <Link to="/notifications/inbox" className="p-1 rounded-md hover:bg-winter-100/50">
                  <ArrowLeft size={20}/>
                </Link>
              ...
              <CardTitle className="font-lora">{`${message.subject}`}</CardTitle>
              <p className="my-4 text-dark-400">{convertDate(message.date)}</p>
              <div className="flex justify-between">
                <div className="flex flex-col text-dark-400">
                  <p className="text-black font-lora font-semibold">From</p>
                  <p>{message.sender}</p>
                ...
                <div className="flex flex-col text-dark-400">
                  <p className="text-black font-lora font-semibold text-right">To</p>
